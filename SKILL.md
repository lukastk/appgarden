...
```bash
appgarden apps meta get myapp                                        # View metadata
appgarden apps meta set myapp --meta team=backend --meta tier=premium # Set/update keys
appgarden apps meta replace myapp --json '{"team": "frontend"}'      # Replace all metadata
appgarden apps meta remove myapp tier visibility                     # Remove specific keys
```
