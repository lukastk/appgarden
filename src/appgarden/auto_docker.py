# AUTOGENERATED! DO NOT EDIT! File to edit: pts/appgarden/07_auto_docker.pct.py

__all__ = ['Runtime', 'console', 'deploy_auto', 'detect_runtime', 'generate_dockerfile', 'infer_setup_command']

# %% pts/appgarden/07_auto_docker.pct.py 3
from dataclasses import dataclass
from pathlib import Path

from .routing import render_template

# %% pts/appgarden/07_auto_docker.pct.py 5
@dataclass
class Runtime:
    name: str
    base_image: str
...
# %% pts/appgarden/07_auto_docker.pct.py 6
...
# %% pts/appgarden/07_auto_docker.pct.py 7
...
# %% pts/appgarden/07_auto_docker.pct.py 8
...
# %% pts/appgarden/07_auto_docker.pct.py 10
...
# %% pts/appgarden/07_auto_docker.pct.py 12
import shlex
...
# %% pts/appgarden/07_auto_docker.pct.py 13
def deploy_auto(
    server: ServerConfig,
    name: str,
    source: str,
