# AUTOGENERATED! DO NOT EDIT! File to edit: pts/appgarden/_dir_server.pct.py

__all__ = ['main']

# %% pts/appgarden/_dir_server.pct.py 3
import fnmatch
import html
import http.server
import io
...
# %% pts/appgarden/_dir_server.pct.py 4
...
# %% pts/appgarden/_dir_server.pct.py 5
...
# %% pts/appgarden/_dir_server.pct.py 6
...
# %% pts/appgarden/_dir_server.pct.py 7
def main() -> None:
    port = int(sys.argv[1])
    root = sys.argv[2]
...
# %% pts/appgarden/_dir_server.pct.py 8
