...
__all__ = ['CADDYFILE_CONTENT', 'CADDYFILE_MARKER_BEGIN', 'CADDYFILE_MARKER_END', 'CADDYFILE_TEMPLATE', 'INIT_STEPS', 'SSH_HARDENING_CONTENT', 'console', 'init_server', 'ping_server']
