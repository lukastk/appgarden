...
__all__ = ['CADDYFILE_MARKER_BEGIN', 'CADDYFILE_MARKER_END', 'CADDYFILE_TEMPLATE', 'INIT_STEPS', 'INIT_STEPS_OFF', 'SSH_HARDENING_CONTENT', 'TEMPLATES_DIR', 'console', 'init_server', 'ping_server']
