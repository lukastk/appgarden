...
__all__ = ['SAMPLE_TOML', 'branch', 'container_port', 'created_at', 'env', 'exclude', 'gitignore', 'meta', 'method', 'name', 'path', 'repo', 'server', 'slug', 'source', 'subdomain', 'test_apps_list_appgarden_server_envvar', 'test_cascade_cli_overrides_env', 'test_cascade_full', 'test_cascade_global_defaults', 'test_cascade_subdomain_overrides_app_default', 'test_cascade_subdomain_to_deploy_params', 'test_cascade_timestamps_flow_through', 'test_cascade_volumes_across_layers', 'test_deploy_appgarden_server_envvar', 'test_deploy_env_name_not_found', 'test_deploy_env_name_requires_toml', 'test_deploy_name_required_without_toml', 'test_derive_app_name_dev', 'test_derive_app_name_production', 'test_derive_app_name_staging', 'test_env_config_to_dict_excludes_empty_meta', 'test_env_config_to_dict_includes_exclude', 'test_env_config_to_dict_includes_meta', 'test_env_config_to_dict_includes_repo', 'test_env_config_to_dict_includes_timestamps', 'test_env_config_to_dict_includes_volumes', 'test_env_config_to_dict_omits_default_gitignore', 'test_env_config_to_dict_omits_empty_volumes', 'test_env_config_to_dict_omits_none_repo', 'test_env_config_to_dict_omits_none_timestamps', 'test_list_environments', 'test_load_project_config', 'test_load_project_config_explicit_dir', 'test_load_project_config_explicit_file_path', 'test_load_project_config_missing', 'test_load_project_config_no_name', 'test_no_placeholder_passthrough', 'test_normalize_timestamp_date_object', 'test_normalize_timestamp_datetime_object', 'test_normalize_timestamp_full_iso', 'test_normalize_timestamp_naive_datetime', 'test_normalize_timestamp_none', 'test_normalize_timestamp_short_date', 'test_placeholder_app_name_in_subdomain', 'test_placeholder_app_slug', 'test_placeholder_app_slug_fallback', 'test_placeholder_env_name', 'test_placeholder_in_app_defaults', 'test_placeholder_in_env_vars', 'test_resolve_all_environments', 'test_resolve_created_at_from_app_defaults', 'test_resolve_env_merges_env_vars', 'test_resolve_exclude_concatenation', 'test_resolve_exclude_dedup', 'test_resolve_exclude_from_app_defaults', 'test_resolve_gitignore_override', 'test_resolve_meta_empty_default', 'test_resolve_meta_env_adds_keys', 'test_resolve_meta_env_overrides_app', 'test_resolve_meta_from_app_defaults', 'test_resolve_path_prefix', 'test_resolve_production', 'test_resolve_repo_from_app_defaults', 'test_resolve_short_date_in_toml', 'test_resolve_staging', 'test_resolve_subdomain', 'test_resolve_timestamps_env_overrides_app', 'test_resolve_unknown_env', 'test_resolve_volumes_concatenation', 'test_resolve_volumes_dedup', 'test_resolve_volumes_empty_default', 'test_slug_not_in_app_defaults', 'updated_at', 'url', 'volumes']
...
# %% pts/tests/test_environments.pct.py 58
...
# %% pts/tests/test_environments.pct.py 59
...
# %% pts/tests/test_environments.pct.py 60
...
# %% pts/tests/test_environments.pct.py 61
...
# %% pts/tests/test_environments.pct.py 62
...
# %% pts/tests/test_environments.pct.py 63
...
# %% pts/tests/test_environments.pct.py 65
from typer.testing import CliRunner
from appgarden.cli import app as cli_app

_runner = CliRunner()

# %% pts/tests/test_environments.pct.py 66
...
# %% pts/tests/test_environments.pct.py 67
...
# %% pts/tests/test_environments.pct.py 68
...
# %% pts/tests/test_environments.pct.py 69
...
# %% pts/tests/test_environments.pct.py 70
...
# %% pts/tests/test_environments.pct.py 72
...
# %% pts/tests/test_environments.pct.py 73
...
# %% pts/tests/test_environments.pct.py 74
...
# %% pts/tests/test_environments.pct.py 75
...
# %% pts/tests/test_environments.pct.py 76
...
# %% pts/tests/test_environments.pct.py 78
...
# %% pts/tests/test_environments.pct.py 79
...
# %% pts/tests/test_environments.pct.py 80
...
# %% pts/tests/test_environments.pct.py 82
def test_normalize_timestamp_none():
    """None returns None."""
    assert _normalize_timestamp(None) is None

# %% pts/tests/test_environments.pct.py 83
...
# %% pts/tests/test_environments.pct.py 84
...
# %% pts/tests/test_environments.pct.py 85
...
# %% pts/tests/test_environments.pct.py 86
...
# %% pts/tests/test_environments.pct.py 87
...
# %% pts/tests/test_environments.pct.py 88
