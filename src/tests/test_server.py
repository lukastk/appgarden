...
__all__ = ['test_init_server_custom_app_root', 'test_init_server_nonroot_uses_sudo', 'test_init_server_nonroot_writes_system_files_via_tmp', 'test_init_server_runs_expected_commands', 'test_init_server_writes_config_files', 'test_ping_server_failure', 'test_ping_server_success']
...
# %% pts/tests/test_server.pct.py 12
...
# %% pts/tests/test_server.pct.py 15
