...
__all__ = ['test_caddyfile_block_migrates_legacy_unkeyed', 'test_caddyfile_block_reinit_replaces_only_that_root', 'test_caddyfile_block_two_instances_coexist', 'test_init_server_caddyfile_additive', 'test_init_server_caddyfile_idempotent', 'test_init_server_creates_state_files_when_missing', 'test_init_server_custom_app_root', 'test_init_server_minimal', 'test_init_server_nonroot_uses_sudo', 'test_init_server_nonroot_writes_system_files_via_tmp', 'test_init_server_preserves_existing_state_files', 'test_init_server_reconciles_existing_app_ports', 'test_init_server_runs_expected_commands', 'test_init_server_seeds_registry_from_legacy_ports', 'test_init_server_skip_steps', 'test_init_server_writes_config_files', 'test_ping_server_failure', 'test_ping_server_success']
