...
__all__ = ['test_caddyfile_block_migrates_legacy_unkeyed', 'test_caddyfile_block_reinit_replaces_only_that_root', 'test_caddyfile_block_transient_read_failure_does_not_clobber', 'test_caddyfile_block_two_instances_coexist', 'test_init_server_caddyfile_additive', 'test_init_server_caddyfile_idempotent', 'test_init_server_corrupt_legacy_ports_fails_loudly', 'test_init_server_creates_state_files_when_missing', 'test_init_server_custom_app_root', 'test_init_server_group_step_scoped_to_managed_subtree', 'test_init_server_host_state_dir_never_user_owned', 'test_init_server_host_state_ownership_minimal', 'test_init_server_host_state_ownership_root_group_skipped', 'test_init_server_minimal', 'test_init_server_nonroot_joins_appgarden_group_without_group_step', 'test_init_server_nonroot_uses_sudo', 'test_init_server_nonroot_writes_system_files_via_tmp', 'test_init_server_preserves_existing_state_files', 'test_init_server_reconciles_existing_app_ports', 'test_init_server_reloads_caddy_not_restart', 'test_init_server_root_no_usermod', 'test_init_server_runs_expected_commands', 'test_init_server_seeds_registry_from_legacy_ports', 'test_init_server_skip_steps', 'test_init_server_writes_config_files', 'test_ping_server_failure', 'test_ping_server_success']
...
# %% pts/tests/test_server.pct.py 28
...
# %% pts/tests/test_server.pct.py 33
...
# %% pts/tests/test_server.pct.py 36
...
# %% pts/tests/test_server.pct.py 43
...
# %% pts/tests/test_server.pct.py 44
...
# %% pts/tests/test_server.pct.py 45
...
# %% pts/tests/test_server.pct.py 46
