...
__all__ = ['test_check_privileged_helper_installed', 'test_check_privileged_helper_missing', 'test_garden_state_roundtrip', 'test_garden_state_with_ctx', 'test_make_remote_context_custom_app_root', 'test_make_remote_context_nonroot', 'test_make_remote_context_root', 'test_path_functions_custom_root', 'test_path_functions_default', 'test_ports_state_locked_other_errors_unchanged', 'test_ports_state_roundtrip', 'test_privileged_install_unit_nonroot', 'test_privileged_install_unit_root', 'test_privileged_journalctl_nonroot', 'test_privileged_journalctl_root', 'test_privileged_remove_unit_nonroot', 'test_privileged_remove_unit_root', 'test_privileged_systemctl_nonroot_caddy_reload', 'test_privileged_systemctl_nonroot_daemon_reload', 'test_privileged_systemctl_nonroot_no_wrapper', 'test_privileged_systemctl_nonroot_wrapper', 'test_privileged_systemctl_root_no_ctx', 'test_privileged_systemctl_root_passthrough', 'test_read_ports_state_locked_permission_hint', 'test_read_remote_file', 'test_read_remote_file_failure', 'test_remote_context_defaults', 'test_run_remote_command', 'test_run_remote_command_failure', 'test_run_sudo_command_no_ctx', 'test_run_sudo_command_no_sudo', 'test_run_sudo_command_with_chain', 'test_run_sudo_command_with_sudo', 'test_upload_directory_exclude_and_gitignore', 'test_upload_directory_exclude_patterns', 'test_upload_directory_gitignore_default', 'test_upload_directory_no_gitignore', 'test_write_ports_state_locked_flock_permission_hint', 'test_write_ports_state_locked_permission_hint', 'test_write_remote_file', 'test_write_remote_file_failure', 'test_write_system_file_no_sudo', 'test_write_system_file_with_sudo']
...
# %% pts/tests/test_remote.pct.py 44
...
# %% pts/tests/test_remote.pct.py 47
...
# %% pts/tests/test_remote.pct.py 60
