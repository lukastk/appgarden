...
__all__ = ['test_deploy_command_creates_systemd_unit', 'test_deploy_command_with_env', 'test_deploy_command_with_meta', 'test_deploy_docker_compose_creates_systemd', 'test_deploy_dockerfile_builds_and_creates_compose', 'test_deploy_static_git_source', 'test_deploy_static_git_with_branch', 'test_deploy_static_registers_in_garden', 'test_deploy_static_subdirectory', 'test_deploy_static_subdomain', 'test_deploy_static_with_exclude', 'test_deploy_static_with_meta', 'test_deploy_static_without_meta', 'test_is_git_url_git_protocol', 'test_is_git_url_https', 'test_is_git_url_local_path', 'test_is_git_url_ssh']
