...
__all__ = ['test_allocate_after_release', 'test_allocate_duplicate_app_returns_existing', 'test_allocate_first_port', 'test_allocate_increments', 'test_empty_ports_state', 'test_register_port', 'test_register_port_advances_next', 'test_register_port_below_next', 'test_register_port_conflict', 'test_release_nonexistent_raises', 'test_release_port']
